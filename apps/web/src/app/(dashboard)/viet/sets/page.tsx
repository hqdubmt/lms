...
import { CATEGORY_LABEL, CATEGORY_COLOR, CATEGORY_OPTIONS } from '@/constants/viet';
          ...
          {filtered.map(set => (
            <button key={set.id}
              ...
              <div className="flex items-start justify-between mb-3">
                <span className={cn('text-xs font-semibold px-2 py-1 rounded-lg', CATEGORY_COLOR[set.category] || 'bg-gray-100 text-gray-600')}>
